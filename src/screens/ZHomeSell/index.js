...
import { heroItems, collectibleItems, forsaleItems } from "../../mocks/homedata";
...
const Data = [
  {
    ...
    components: [
      ...
      <Collectables classSection="section" title="Travel Collectables" bids={collectibleItems} />,
            ...
            {Data.map((x, index) => (
              <NavItem>
                <NavLink
                  ...
                  onClick={() => { toggle(x.tab); }}>
                  <p className={cn(styles.link, (activeTab===x.tab?styles.custom:" "))}>{x.title}</p>
                </NavLink>
              </NavItem>
            ))}
          </Nav>
